...
num_cells = 140
signals_per_mux = 5
num_mux = num_cells // signals_per_mux  # 28
...
dbc_content.append('BO_ 256 individual_temperature: 8 ECU\n')
...
for mux in range(1, num_mux + 1):
    ...
    for i in range(signals_per_mux):
        ...
        start_bit = 8 + i * 10
        dbc_content.append(f' SG_ cell_temp_{cell_num} m{mux} : {start_bit}|10@1+ (1,0) [0|1024] "C" ECU\n')
    dbc_content.append('\n')

# Write to DBC file
with open('individual_temperature_10bit.dbc', 'w') as file:
    file.writelines(dbc_content)

print("DBC file 'individual_temperature.dbc' has been generated successfully.")
