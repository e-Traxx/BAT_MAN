...
# group Inc
add_library(Group_Source_Files_Inc OBJECT
  "${SOLUTION_ROOT}/BAT-MAN_CMSIS/Inc_c/spi_handler.c"
  "${SOLUTION_ROOT}/BAT-MAN_CMSIS/Inc_c/usb_handler.c"
)
target_include_directories(Group_Source_Files_Inc PUBLIC
  $<TARGET_PROPERTY:Group_Source_Files,INTERFACE_INCLUDE_DIRECTORIES>
  ${SOLUTION_ROOT}/BAT-MAN_CMSIS/Inc
)
target_compile_definitions(Group_Source_Files_Inc PUBLIC
  $<TARGET_PROPERTY:Group_Source_Files,INTERFACE_COMPILE_DEFINITIONS>
)
target_compile_options(Group_Source_Files_Inc PUBLIC
